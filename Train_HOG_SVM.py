...
pos_im_path = r"human detection dataset\1" # This is the path of our positive input dataset
# define the same for negatives
neg_im_path= r"human detection dataset\0"
